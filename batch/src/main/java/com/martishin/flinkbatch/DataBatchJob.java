...
import com.martishin.flinkbatch.dto.CategorySalesDTO;
import com.martishin.flinkbatch.entities.OrderItem;
import com.martishin.flinkbatch.entities.Product;
...
//                "\n", ",", FileSystem.WriteMode.OVERWRITE);
        ...
        categorySales.output(new OutputFormat<CategorySalesDTO>() {
            ...
            public void open(int taskNumber, int numTasks) throws IOException {
                File outputFile = new File("/output/new-output.csv");
